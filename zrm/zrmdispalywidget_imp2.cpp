                                      ...
                                      , bool details, const zrm::method_exec_results_t & results)
{
    ...
    auto hms = zrm::ZrmConnectivity::secunds2hms(total_duration);
...
void ZrmDisplayWidget::setup_method    ()
{
  ...
  lbStageTotal->setNum(int(method.stages_count()));
  stages_clear();
  auto met_volt = method.m_method.voltage();
  auto met_curr = method.m_method.current();
  auto met_cap  = method.m_method.capacity();

  lb_method_name->setText(to_utf(method.m_method.name,sizeof(method.m_method.name)));
...
void ZrmDisplayWidget::stage_add(const zrm::stage_t & stage, qreal met_volt, qreal met_current, qreal met_cap)
{
  ...
  if(stage.m_end_flag & zrm::EndStageOfTime)
    {
      QTreeWidgetItem * sitem = new QTreeWidgetItem;
  ...
  if(stage.m_end_flag & zrm::EndStageOfCurrency)
    {
      QTreeWidgetItem * sitem = new QTreeWidgetItem;
  ...
  if(stage.m_end_flag & zrm::EndStageOfVoltage)
    {
      QTreeWidgetItem * sitem = new QTreeWidgetItem;
  ...
  if(stage.m_end_flag & zrm::EndStageOfChangeVoltage)
    {
      QTreeWidgetItem * sitem = new QTreeWidgetItem;
  ...
  if(stage.m_end_flag & zrm::EndStageOfCellVoltage)
    {
      QTreeWidgetItem * sitem = new QTreeWidgetItem;
  ...
  if(stage.m_end_flag & zrm::EndStageOfTemp)
    {
      QTreeWidgetItem * sitem = new QTreeWidgetItem;
  ...
  if(stage.m_end_flag & zrm::EndStageOfCapacity)
    {
      QTreeWidgetItem * sitem = new QTreeWidgetItem;
