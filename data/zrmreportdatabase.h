...
public:
   ...
   ~ZrmReportDatabase();
    ...
    bool                  report_write         (int user_id, int serial_number_id, const zrm::method_exec_results_t & exec_result);
...
ZrmReportDatabase  *      get_main_instance();
      ...
      bool report_update(QSqlDatabase & db, const QVariant& rep_id, uint32_t total_duration  , qreal total_energy, qreal total_capacity);
