...
public:
	...
	static bool          exec_write(QSqlDatabase& db, QSqlQuery& query, const QString& qtext, query_args_t& args);

	static QSqlQuery     read_all_methods(QSqlDatabase& db );
	static QSqlQuery     read_model_methods(QSqlDatabase& db, const QVariant& model_id);
	static QSqlQuery     read_method(QSqlDatabase& db, const QVariant& id  );
	static bool          read_method(QSqlDatabase& db, const QVariant& id, zrm::method_t& result, double voltage = 1, double capacity  = 1);
	static QSqlQuery     read_method_stages(QSqlDatabase& db, const QVariant& m_id );
	static bool          read_method_stages(QSqlDatabase& db, const QVariant& m_id, zrm::stages_t& result);
	static QString       read_stage_descript(QSqlDatabase& db, const QVariant& stage_id);

	static bool          link_method(QSqlDatabase& db, const QVariant& method_id, const QVariant& model_id);
	static bool          unlink_method(QSqlDatabase& db, const QVariant& method_id, const QVariant& model_id);
	static bool          erase_method(QSqlDatabase& db, const QVariant& method_id);
	static bool          erase_stages(QSqlDatabase& db, const QVariant& method_id);
	static bool          erase_stages(QSqlDatabase& db, zrm::stages_t& stages);
	static bool          erase_stage(QSqlDatabase& db, const QVariant& stage_id);
	static bool          wrte_method(QSqlDatabase& db, QVariant& method_id, const QString& method_name, zrm::zrm_method_t& method);
	static bool          wrte_method_uservals(QSqlDatabase& db, const QVariant& method_id, const QVariant& user_volt, const QVariant& user_capacity, bool commit_trans = true);
	static bool          write_stages(QSqlDatabase& db, QVariant& method_id, zrm::stages_t& stages, zrm::stages_t& remove_stages);
	static bool          write_stage(QSqlDatabase& db, QVariant& method_id, zrm::stage_t&   stage);
	static bool          write_stage_descript(QSqlDatabase& db, const QVariant& stage_id, const QString& stage_descript);
