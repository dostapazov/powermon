...
public:
	...
	QVariant method_id();
	void set_method_id(const QVariant& id );
	double voltage();
	double capacity();
	double capacity_percent();
	void set_capacity_percent(double perc, bool update = true);
...
protected:
	...
	QtCharts::QChart*       m_chart = Q_NULLPTR;
	QtCharts::QLineSeries* m_u_series = Q_NULLPTR;
	QtCharts::QLineSeries* m_i_series = Q_NULLPTR;
